...
import { getFilteredPayments } from "@/services/payment.service";
...
export default async function PaymentsPage({ searchParams }: DashboardProps) {
	...
	const { payments: displayPayments, hasNextPage } = await getFilteredPayments({
		...
		<div className="min-h-screen bg-slate-50 text-slate-900 pb-16">
			...
			<div className="bg-white border-b border-slate-200 py-8 mb-10">
				<div className="container mx-auto px-4 max-w-4xl">
					<TransactionControlPanel type="payments"/>
