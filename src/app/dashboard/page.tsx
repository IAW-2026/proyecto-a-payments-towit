...
import { getPaymentsUser, PaymentsUser } from "@/app/lib/auth";
        ...
        <div className="w-full flex flex-col items-center gap-6">
          ...
          <div className="w-full flex flex-col items-center gap-6">
            {displayPayments.map((tx) => (
              <Link
                href={`/dashboard/transacciones/${tx.trip_id}`}
                key={tx.trip_id}
                ...
                */}
                <div className="w-full transition-all duration-200 hover:-translate-y-1 active:scale-[0.99] group-hover:shadow-xl rounded-2xl">
                  <PaymentCard
                    ...
                    clientName={paymentsUser.fullName} // Metadata de presentación
                    amount={tx.amount}
          ...
          {displayPayments.length === 0 && (
            <div className="text-center py-16 bg-white rounded-2xl border border-slate-200 border-dashed w-full">
              ...
              {currentPage > 1 && (
                <Link href="/dashboard?page=1" className="text-blue-600 text-sm font-semibold hover:underline mt-2 inline-block">
