    ...
    <div className="min-h-[calc(screen-16rem)]">
      ...
      <main className="container mx-auto px-4 py-16 md:py-24 flex flex-col items-center text-center">
        ...
        <Show when="signed-out">
          ...
          <TransactionCard
            tripId={"1723123"}
            entityName={"Carlos Alberto Solari"} // Metadata de presentación
            amount={14760}
            status={ "COMPLETED" }
            type={ "DISBURSEMENT" }
          />
          ...
          <div className="text-center">
            <p className="text-slate-500 mb-4">Inicia sesión con tu cuenta corporativa para acceder a tu historial de transacciones.</p>
