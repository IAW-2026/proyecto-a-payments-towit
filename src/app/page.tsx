			...
			<main className="container mx-auto px-4 py-16 md:py-24 flex flex-col items-center">
				...
				<Show when="signed-out">
					<div className="flex flex-col items-center text-center w-full max-w-3xl mx-auto">
						...
						{/* FIX 2: text-3xl en móviles para evitar overflow de palabras largas, break-words como red de seguridad */}
						...
						{/* Este componente debe ser responsive por dentro (w-full max-w-sm sm:max-w-md, etc.) */}
