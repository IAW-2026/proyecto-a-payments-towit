...
export type TransactionType = "PAYMENT" | "DISBURSEMENT" | "REFUND";
export type TransactionStatus = "PENDING" | "COMPLETED" | "FAILED" | "CANCELLED" | "REQUESTED";

export interface TransactionCardProps {
  tripId: string;
  entityName: string; // Nombre del Cliente o del Conductor
  amount: number | string;
  status: TransactionStatus | string;
  type: TransactionType;
  refundType?: "TOTAL" | "PARTIAL" | string; // Solo usado si type === "REFUND"
}
...
export default function TransactionCard({
  ...
  // Idealmente, esto debería venir de src/lib/utils.ts
